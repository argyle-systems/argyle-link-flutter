...
private struct ConfigKeys {
    ...
    static let linkItemIds = "linkItemIds"
    static let pdConfig = "pdConfig"
    static let pdItemsOnly = "pdItemsOnly"
    static let pdUpdateFlow = "pdUpdateFlow"
    static let pdAutoTrigger = "pdAutoFlow"
    static let sdkCustomisationId = "customisationId"
