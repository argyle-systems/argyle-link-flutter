...
class JsonDemoBuildApp extends StatefulWidget {
  const JsonDemoBuildApp({Key? key}) : super(key: key);

  @override
  State<JsonDemoBuildApp> createState() => _JsonDemoBuildAppState();
}

class _JsonDemoBuildAppState extends State<JsonDemoBuildApp> {
  String log = '';
